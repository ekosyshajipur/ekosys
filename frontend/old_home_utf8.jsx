...
const testimonials = [
  ...
  { name: "Priya Singh", loc: "Patna, Bihar", text: "I was confused about solar subsidy, but EKOSYS guided me through the entire PM Surya Ghar process. Got Ôé╣98,000 subsidy credited to my account within 3 months!", rating: 5 },
...
const faqs = [
  { q: "What is the cost of a solar system in Bihar?", a: "Residential systems cost Ôé╣55,000 to Ôé╣65,000 per kW before subsidy. With PM Surya Ghar Yojana, you can get Ôé╣30,000-Ôé╣98,000 subsidy depending on system size." },
  { q: "How does PM Surya Ghar Yojana work?", a: "Under this scheme, households get up to Ôé╣98,000 subsidy for on-grid rooftop solar, credited directly to their bank account after installation and inspection." },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="EKOSYS is Bihar's #1 solar installation company offering rooftop solar panels, PM Surya Ghar Yojana subsidy assistance, solar EPC services for homes, businesses & industries. Get up to Ôé╣98,000 government subsidy. Call +91-7644868086." />
      ...
      <section className="hero-v2">
        ...
        <div className="container hero-v2-inner">
          <motion.div className="hero-v2-content" initial={{ opacity: 0, x: -60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p>End-to-end solar EPC solutions for homes, businesses & industries. Get up to Ôé╣98,000 government subsidy under PM Surya Ghar Yojana.</p>
